...
class DocumentParser {
    ...
    parsePicture(elem) {
        ...
        var nvPicPr = xml_parser_1.default.element(elem, "nvPicPr");
        var cNvPr = xml_parser_1.default.element(nvPicPr, "cNvPr");
        result.altText = xml_parser_1.default.attr(cNvPr, "descr");
        result.cssStyle["position"] = "relative";
        ...
        if (this.document) {
            this.document.loadDocumentImage(elem.src, this.currentPart).then(x => {
                ...
                if (this.options?.onImage) {
                   return this.options.onImage(elem.src, result);
                }
            });
        }
        return result;
